...
peer channel fetch 0 ./channel-artifacts/mytestchannel.block -o ${HLF_ORDR_HOST}:7050 --ordererTLSHostnameOverride $HLF_ORDR_ID -c mytestchannel --tls --cafile $ORDERER_CA
...
peer channel update -o ${HLF_ORDR_HOST}:7050 --ordererTLSHostnameOverride $HLF_ORDR_ID -c mytestchannel -f ./channel-artifacts/Org2MSPanchors.tx --tls --cafile $ORDERER_CA
