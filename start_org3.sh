...
peer channel update -o ${HLF_ORDR_HOST}:7050 --ordererTLSHostnameOverride $HLF_ORDR_ID -c mytestchannel -f ./channel-artifacts/Org3MSPanchors.tx --tls --cafile $ORDERER_CA
